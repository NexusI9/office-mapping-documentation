import Image from "next/image";
 ...
 function Shortcut(){
    ...
    return (<>
        ...
        <img src="/mapping/screenshots/notfound.webp" alt="not found" width="600" height="450" />
        ...
        <ol>
            <li>
                ...
                <img src="/mapping/screenshots/disko.webp" alt="not found" width="600" height="450" />
            </li>
            <li>
            ...
            <li>
                ...
                <ol type="a">
                    ...
                    <li>
                        ...
                        <img src="/mapping/screenshots/map.webp" alt="map directory" width="600" height="450" />
                    </li>
                    <li>
                        Dans la liste des Drive, choisir la lettre <b>V:</b>
                        <img src="/mapping/screenshots/vdrive.webp" alt="v drive directory" width="600" height="450" />
                    </li>
